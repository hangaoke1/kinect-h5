...
// 	["#FFFFFF", "fs-loc-green", "A Franklin Ave shuttle", 36,
// 		[[100,100],[100,400],[100,700]]
// 	],
// 	// this is the grand central shuttle - says 1 minute but make it more
// 	["#FFFFFF", "sh-loc-mid-green", "A Grand Central shuttle", 36,
// 		[[200,100],[200,400], [200,700]]
// 	],
// 	["#FFFFFF", "r-loc-green", "An R train", 36,
// 		// vector goes from bottom to top
// 		[[300,100],[300,400],[300,700]]
// 	],
// 	["#FFFFFF", "q-loc-red", "A Q train", 36,
// 		// vector goes from bottom to top
// 		[[400,100],[400,400],[400,700]]
// 	],
// 	["#FFFFFF", "n-exp-yello", "An N train", 36,
// 		// vector goes from bottom to top
// 		[[500,100],[500,400],[500,700]]
// 	],
// 	// Changed now to split, estimated
// 	["#FFFFFF", "m-exp-cyan", "An M train", 36,
// 		// vector goes bottom to top
// 		[[600,100],[600,400],[600,700]]
// 	],
// 	["#FFFFFF", "l-gray", "An L train", 36,
// 		// vector goes from left to right
// 		[[700,100],[700,400],[700,700]]
// 	],
// 	["#FFFFFF", "j-exp-gray", "A J train", 36,
// 		// vector goes lower left to upper right
// 		[[800,100],[800,400],[800,700]]
// 	],
// 	// Current G only takes 34 min but used to go further into queens - added another 15 min
// 	["#FFFFFF", "g-loc-teal", "A G train", 36,
// 		// vector goes from bottom to top
// 		[[900,100],[900,400],[900,700]]
// 	],
// 	["#FFFFFF", "f-exp-pink", "An F train", 36,
// 		// goes from bottom to top
// 		[[1000,100],[1000,400],[1000,700]]
// 	],
// 	// On vignelli it goes from forest hills queens to around world trade center area
// 	["#FFFFFF", "e-loc-orange", "An E train", 36,
// 		// vector goes from bottom left to to top right
// 		[[1100,100],[1100,400],[1100,700]]
// 	],
// 	// E on Vignelli is going all the way from queens to rockaway pk. Estimated 46+44 min = 90
// 	["#FFFFFF", "e-exp-cyan", "An E train", 36,
// 		// goes from bottom to top
// 		[[1200,100],[1200,400],[1200,700]]
// 	],
// 	["#FFFFFF", "d-exp-orange", "A D train", 36,
// 		// vector goes from top to bottom
// 		[[1300,100],[1300,400],[1300,700]]
// 	],
// 	["#FFFFFF", "c-loc-green", "A C train", 36,
// 		// vector goes from top to bottom
// 		[[1400,100],[1400,400],[1400,700]]
// 	],
// 	["#FFFFFF", "b-exp-gray", "A B train", 36,
// 		// vector goes from top to bottom
// 		[[100,100],[1200,100]]
// 	],
// 	["#FFFFFF", "a-loc-pink", "An A local train", 36,
// 		// goes from top to bottom
// 		[[100,200],[1200,200]]
// 	],
// 	//
// 	["#FFFFFF", "a-exp-blue", "An A express train", 36,
// 		// goes from bottom to top
// 		[[100,300],[1200,300]]
// 	],
// 	// no longer active, no way to estimate - 45 seems fine
// 	["#FFFFFF", "k-loc-dead-blue", "A K train", 36,
// 		// vector goes from left to right
// 		[[100,400],[1200,400]]
// 	],
// 	["#FFFFFF", "8-loc-dead-blue", "An 8 train", 36,
// 		[[100,500],[1200,500]]
// 	],
// 	["#FFFFFF", "7-loc-pink", "A 7 train", 36,
// 		// vector goes left to right
// 		[[100,600],[1200,600]]
// 	],
// 	// trip was around 56 minutes, need to add 10 min for more stops
// 	["#FFFFFF", "6-exp-yellow", "A 6 train", 36,
// 		// vector goes top to bottom
// 		[[100,700],[1200,700]]
// 	],
// 	["#FFFFFF", "5-exp-gray", "A 5 train", 36,
// 		// vector goes from top to bottom
// 		[[100,800],[1200,800]]
// 	],
// 	["#FFFFFF", "4-exp-pink", "A 4 train", 36,
// 		// vector goes from top to bottom
// 		[[100,900],[1200,900]]
// 	],
// 	["#FFFFFF", "3-exp-blue", "A 3 train", 36,
// 		// goes from top to bottom
// 		[[100,1000],[1200,1000]]
// 	],
// 	["#FFFFFF", "2-exp-pink", "A 2 train", 36,
// 		// goes from top to bottom
// 		[[100,1100],[1200,1100]]
// 	],
// 	["#FFFFFF", "1-loc-orange", "A 1 train", 36,
// 		// goes from top to bottom
// 		[[100,1200],[1200,1200]]
// 	]
// ];
...
arrData = arrData.map(item => {
  item[4].forEach(subitem => {
    subitem[0] = subitem[0] * 1.6
  })
  return item
})
...
var Main = function() {
	...
	this.wBox = window.innerWidth; this.hBox = window.innerHeight;
...
Main.prototype.begin = function() {
	...
	// this.elmAbout.innerHTML = "<a href=\"http://www.chenalexander.com/Mta-me\" target=\"_blank\">&nbsp;&nbsp;?&nbsp;</a>";
}
...
Main.prototype.upd = function() {
  ...
  this.cv1.clearRect(0, 0, window.innerWidth, window.innerHeight); 
  for(var key in kpeople) {
    // if (kpeople[key].handState === 2) {
      this.cv1.beginPath();
      this.cv1.fillStyle = '#ff0000';
      this.cv1.arc(kpeople[key].handle.x, kpeople[key].handle.y, 5, 0, Math.PI*2, false);
      this.cv1.closePath();
      this.cv1.fill();
    // }
  }
...
Main.prototype.updTime = function() {
	...
	if (this.tWorldAccum >= SEC_IN_DAY-(this.ff1*15)) {
		...
		if (this.tWorld > this.tTrue) { 
      var tOff = this.tTrue + SEC_IN_DAY - this.tWorld; 
    } else { 
      var tOff = this.tTrue - this.tWorld; 
    }
    ...
    bodyFrame.bodies.forEach(function(body, index) {
      if (body.tracked) {
        ...
        for (var jointType in body.joints) {
          ...
          var putDot = true;
          if (jointType == 11) {
            var hand_x = joint.depthX * window.innerWidth * 1.4
            var hand_y = joint.depthY * window.innerHeight * 1.4
            // 记录右手位置
            kpeople[index].handle = {
              x: hand_x,
              y: hand_y
            }
            pmouseX = mouseX; pmouseY = mouseY;
            mouseX = hand_x; mouseY = hand_y;
          }
        }
        kpeople[index].handState = body.rightHandState
        // 手掌
        // if (body.rightHandState === 2) {
          mousePressed = true;
          if (m.mouseDown != undefined) m.mouseDown();
        // } else {
        //   mousePressed = false;
        //   if (m.mouseUp != undefined) m.mouseUp();
        // }
      }
    });
  });
