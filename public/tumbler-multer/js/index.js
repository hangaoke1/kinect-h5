  ...
  SoundManager = {
    ...
    load: function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        soundName = _ref[_i];
        _results.push(this.loadSound_(soundName, '/tumbler-multer/sounds/' + sounds[soundName]));
      }
      return _results;
    },
    getContext: function() {
...
(function() {
  window.Utilities = {
    ...
    randomColor: function() {
      ...
      allColors = ["#f2d6ce", "#e86583", "#517a74", "#74a39d", "#9fd1be", "#d8edd7"];
